	...
	console.log("new message");
      ...
      if(pron.length===2&&pron[0].toLowerCase()==="listen")
      {
          ...
          Pron.prons(pron[1],chatId,function(result)
          {
            ...
            sms("".file,chatId,TOKEN,"audio/mp4");
          })
      }
      else
      {  var a=[];
